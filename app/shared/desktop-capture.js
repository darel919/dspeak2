...
export class DesktopCaptureError extends Error {
  constructor(message, { code, operation = "capture", details = null } = {}) {
    super(message);
...
export function nativeCaptureFailure(
  error,
  { operation = "capture", selection = null } = {},
) {
...
export function desktopCaptureRequest(selection, options = {}) {
...
export function createDesktopCaptureSelection(source, mode, options = {}) {
...
export function desktopCaptureInvoke(invoke, command, payload = {}) {

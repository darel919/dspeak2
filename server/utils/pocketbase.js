...
async function createAdminClient() {
  ...
  const password = process.env.PBASE_ADMIN_PASSWORD || config.pocketbase.adminPassword

  if (!url || !email || !password) {
    throw new Error('POCKETBASE_URL, PBASE_ADMIN_EMAIL and PBASE_ADMIN_PASSWORD are required')
  }

...
import { buildVoiceProducerOptions, getActiveMediaDirections, getAudioBitrateBps, getAverageJitterBufferDelayMs, getReconnectDelayMs, getRtcSignalMetrics, getTransportRecoveryDelayMs, mapPeerConnectionMetrics, mapPeerRoundTripTimes } from '../app/shared/voice-transport.js'
...
test('P2P signal metrics are addressable by participant user ID', () => {
  ...
  assert.deepEqual(metrics['user-2'], { rttMs: 5, packetLossPercent: 6, jitterMs: 24 })

...
const storeSource = await readFile(
  new URL("../app/stores/friends.ts", import.meta.url),
  "utf8",
);
...
const managerSource = await readFile(
  new URL("../server/utils/friends-manager.ts", import.meta.url),
  "utf8",
);
...
const routeSource = await readFile(
  new URL("../server/routes/api/friends/index.ts", import.meta.url),
  "utf8",
);

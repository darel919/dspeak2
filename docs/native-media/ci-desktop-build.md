...
macOS uses the pinned libwebrtc archive published by libmediasoupclient because
the self-hosted runner has limited disk space. Windows builds libwebrtc from the
pinned WebRTC sources.
